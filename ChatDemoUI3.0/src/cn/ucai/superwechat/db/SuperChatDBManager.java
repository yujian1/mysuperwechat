...
public class SuperChatDBManager {
    static private SuperChatDBManager dbMgr = new SuperChatDBManager();
    private DbOpenHelper dbHelper;
    
    private SuperChatDBManager(){
        dbHelper = DbOpenHelper.getInstance(SuperChatApplication.getInstance().getApplicationContext());
    }
    
    public static synchronized SuperChatDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new SuperChatDBManager();
        }
        return dbMgr;
    }
